    ...
    <div>
      ...
      >
        ...
        {loading ? (
          ...
          <>
            <p className="text-sm text-slate-200 font-medium leading-snug">Drop {label} file or click to upload</p>
            <p className="text-[11px] text-slate-500 mt-1">{acceptedTypes.join(' · ').toUpperCase()}</p>
          </>
        )}
      </div>
      {error && (
